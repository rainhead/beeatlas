...
- 🔄 **v4.9 Map-Init Readiness** — Phase 144 (active, started 2026-06-09). Retire the recurring map-init race class with named readiness barriers (`ready.ts`, step 1 shipped in quick task 260608-tnc), await-based legacy-taxon resolution, and a single `intendedFilterActive` gate so render = f(intent).

## Phases

### 🔄 v4.9 Map-Init Readiness (Phase 144) — ACTIVE (started 2026-06-09)
