...
- [x] **INFRA-03**: GitHub Actions workflow builds frontend on all pushes; deploys to S3 and invalidates CloudFront on push to `main`
...
| INFRA-03 | Phase 6 (gap closure) | Complete |
