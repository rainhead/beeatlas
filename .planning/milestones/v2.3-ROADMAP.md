...
- [x] **Phase 51: Frontend Link Rendering** — Show specimen photo link in sidebar detail view (completed 2026-04-13)
...
**Plans**: 1 plan
Plans:
- [x] 51-01-PLAN.md — Add specimenObservationId to data flow (interface, OL mapping, DuckDB query) and render as camera emoji link in bee-specimen-detail
**UI hint**: yes
