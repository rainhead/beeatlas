...
_No active milestone._ v4.7 (Checklist Records as Point Data) shipped 2026-06-08; v4.8 (Fast, Honest Test Suite) shipped 2026-06-08. Next milestone planning is open — run `/gsd:new-milestone` to define it. Fresh requirements will be created then (`.planning/REQUIREMENTS.md` was archived at the v4.7 close).
...
---
*Last updated: 2026-06-08 after the v4.7 (Checklist Records as Point Data) milestone close — 21/21 requirements validated (ING/RCN/DUP/PRO/UIX), audit passed, archived to `.planning/milestones/v4.7-*`. Checklist is now a real 4th occurrence source (green map points, full detail card, deduped counts) promoted into `occurrences.parquet`, reversing the Phase 111 lock. v4.8 (Fast, Honest Test Suite) also shipped 2026-06-08 (17/17). No active milestone — next: `/gsd:new-milestone`. Backlog: Phase 999.1 (debounce URL updates on map move), 999.2 (dependabot).*
