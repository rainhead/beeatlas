...
# ---------------------------------------------------------------------------
# (The GET /api/notes?species= live-read route and its tests died with
# st-vjd. The approved-only leak boundary [D-10, T-179-LEAK] is enforced —
# and tested — at the harvest: data/tests/test_notes_harvest.py.)
# ---------------------------------------------------------------------------
