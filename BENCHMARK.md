...
Recorded manually from Chrome DevTools console after running `pnpm run dev`.
...
- Bundle size measured via `pnpm run build` (Vite output) after Phase 61 cleanup. duckdb.ts was already
