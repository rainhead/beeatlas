...
// checklist_id appended at index 7; sqlite_export.py _GEO_COLS updated in the same commit (positional coupling).
...
// from the full wa-sqlite row query, not from map feature properties (page-weight budget).
